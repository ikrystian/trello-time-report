...
function calculateListTotalTime(t, listId) {
  return Promise.all([t.cards("id", "name", "idList"), t.lists("id", "name")])
...
function calculateListEstimatedTime(t, listId) {
  return Promise.all([t.cards("id", "name", "idList")])
    .then(function ([cards]) {
      // Filtrowanie kart dla danej listy
      const listCards = cards.filter((card) => card.idList === listId);
...
TrelloPowerUp.initialize(
  {
    ...
    "board-buttons": function (t) {
      return [
        ...
        {
          icon: {
            dark: "https://img.icons8.com/ios-filled/50/000000/bulleted-list--v1.png",
            light:
              "https://img.icons8.com/ios-filled/50/ffffff/bulleted-list--v1.png",
          },
          text: "Czas list",
          callback: function (t) {
            return t.popup({
              title: "Czas zaraportowany na listach",
              url: "./list-time-dropdown.html",
              height: 350,
            });
          },
        },
    ...
    "card-back-section": function (t) {
      return t
        .get("card", "shared", TIME_ENTRIES_KEY)
        .then(function (timeEntries) {
          ...
          return {
            ...
            content: {
              ...
              height:
                timeEntries.length <= 3 ? 50 + timeEntries.length * 60 : 250,
            },
          };
        });
    },
